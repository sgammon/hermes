...
this.Base64={map:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",h:function(a){var d="",b=0;a=this.k.h(a);for(var c=this.map,e,g,f,l,n;b<a.length;)e=a.charCodeAt(b++),g=a.charCodeAt(b++),f=a.charCodeAt(b++),l=e>>2,e=(e&3)<<4|g>>4,n=isNaN(g)?64:(g&15)<<2|f>>6,g=isNaN(g)||isNaN(f)?64:f&63,d=d+c.charAt(l)+c.charAt(e)+c.charAt(n)+c.charAt(g);return d},f:function(a){var d="",b=0;a=a.replace(/[^A-Za-z0-9\+\/\=]/g,"");for(var c=this.map,e,g,f,l,n;b<a.length;)e=c.indexOf(a.charAt(b++)),
g=c.indexOf(a.charAt(b++)),f=c.indexOf(a.charAt(b++)),l=c.indexOf(a.charAt(b++)),e=e<<2|g>>4,g=(g&15)<<4|f>>2,n=(f&3)<<6|l,d+=w(e)+(64!=f?w(g):"")+(64!=l?w(n):"");return this.k.f(d)},k:{h:function(a){for(var d="",b=0,c;b<a.length;)c=a.charCodeAt(b++),d+=128>c?w(c):127<c&&2048>c?w(c>>6|192)+w(c&63|128):w(c>>12|224)+w(c>>6&63|128)+w(c&63|128);return d},f:function(a){for(var d="",b=0,c=0;b<a.length;)c=a.charCodeAt(b),d+=128>c?[w(c),b++][0]:191<c&&224>c?[w((c&31)<<6|a.charCodeAt(b+1)&63),b+=2][0]:[w((c&
15)<<12|(a.charCodeAt(b+1)&63)<<6|a.charCodeAt(b+2)&63),b+=3][0];return d}}};var x=this;function y(a){this.state={n:h,o:h,t:{G:[],C:[],w:h,host:"amp.sh"}};this.p(a).load()}y.prototype.b={a:"amp-tracker",e:"amp-deferred"};y.prototype.a={key:"_amp",debug:j,i:[JSON.stringify,JSON.parse],j:window.localStorage||j,d:{g:function(a){return window.btoa(a)},l:function(a){return window.atob(a)}}};
